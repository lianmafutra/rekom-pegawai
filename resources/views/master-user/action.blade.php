...
<div class="btn-group-vertical">
    ...
    <div class="btn-group">
        ...
        <ul class="dropdown-menu">
            ...
            <li><a data-nama="{{ $data->username }}" data-id="{{ $data->id }}"  href="#" class="btn_hapus_user dropdown-item">Hapus
               <form hidden id="form-delete" action="{{ route('master-user.destroy', $data->uuid) }}" method="POST"> @csrf
                  @method('DELETE')
              </form>
            </a> </li>
